      ...
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col gap-3 px-4 pb-4 pt-4">
        <header className="flex items-start justify-between gap-3">
          ...
          <div className="flex max-w-[56%] flex-col items-end gap-2">
            <div className="language-select-wrap relative flex w-full items-center justify-end gap-2">
              <select
                value={settings.language}
                onChange={(e) => onLanguageChange(e.target.value)}
                className="app-select h-8 min-w-0 flex-1 rounded-lg py-1 pl-2.5 pr-7 text-xs font-semibold text-app-text outline-none transition"
              ...
              <span className="pointer-events-none absolute right-11 top-1/2 -translate-y-1/2 text-[10px] text-app-subtle">▾</span>
